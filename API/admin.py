...
class UserPlantAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'plant', 'nickname', 'added_at')
...
class SiteAdmin(admin.ModelAdmin):
    list_display = ('id','name', 'user', 'light', 'location')
...
class UserPlantTaskAdmin(admin.ModelAdmin):
    list_display = ('id','user_plant', 'name', 'interval', 'unit', 'last_completed_at', 'description')  # Fields to display in list view
...
class TaskToCheckAdmin(admin.ModelAdmin):
    list_display = ('id','user_plant_task', 'due_date', 'is_completed', 'completed_at')  # Display these fields in the list
